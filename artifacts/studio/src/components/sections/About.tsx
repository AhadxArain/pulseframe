...
export default function About() {
  return (
    <section id="about" className="py-20 sm:py-24 md:py-28 lg:py-32 relative bg-background overflow-hidden">
      {/* Decorative Blur */}
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-primary/5 rounded-full blur-[60px] sm:blur-[120px] pointer-events-none" />
          ...
          >
            <div className="aspect-[4/5] sm:aspect-[4/5] lg:aspect-[4/5] max-h-[70vh] lg:max-h-none relative bg-card/20 rounded-sm overflow-hidden">
              ...
              <div className="absolute bottom-5 right-5 sm:bottom-8 sm:right-8 z-20 bg-background/80 backdrop-blur-md border border-white/10 p-4 sm:p-6 max-w-[180px] sm:max-w-[200px]">
                <div className="w-3 h-3 bg-primary rounded-full mb-3 sm:mb-4 shadow-[0_0_10px_rgba(255,42,42,0.8)]" />
