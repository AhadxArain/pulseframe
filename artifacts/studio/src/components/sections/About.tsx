...
export default function About() {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-32 relative bg-background border-t border-white/5 overflow-hidden">
      {/* Decorative Blur */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="font-display tracking-widest text-primary uppercase text-sm font-semibold">The Studio</span>
            </div>
            ...
            <div className="mt-12 flex items-center gap-8">
              <div>
                <p className="text-4xl font-display font-bold text-white mb-2">12+</p>
                <p className="text-xs uppercase tracking-widest text-muted-foreground">Years Experience</p>
              </div>
              <div className="w-[1px] h-12 bg-white/10" />
              <div>
                <p className="text-4xl font-display font-bold text-white mb-2">200+</p>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-[4/5] relative bg-card/20 rounded-sm overflow-hidden">
              ...
              {/* Overlaid Badge */}
              <div className="absolute bottom-8 right-8 z-20 bg-background/80 backdrop-blur-md border border-white/10 p-6 max-w-[200px]">
                <div className="w-3 h-3 bg-primary rounded-full animate-pulse mb-4 shadow-[0_0_10px_rgba(255,42,42,0.8)]" />
                <p className="text-sm font-display text-white uppercase tracking-wider mb-1">State of the Art</p>
                <p className="text-xs text-muted-foreground">Analog warmth meets digital precision.</p>
              </div>
            </div>
            
            {/* Red accent frame */}
            <div className="absolute -inset-4 border border-primary/20 -z-10 translate-x-8 translate-y-8" />
          </motion.div>
