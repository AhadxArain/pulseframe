    ...
    >
      ...
      <div className="container relative z-20 mx-auto px-6 md:px-12 text-center flex flex-col items-center">
        <motion.div
          ...
          className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-primary/30 bg-primary/5 backdrop-blur-sm mb-8"
        >
          <div className="w-2 h-2 rounded-full bg-primary animate-pulse shadow-[0_0_10px_rgba(255,42,42,0.8)]" />
          <span className="text-xs font-display tracking-widest text-primary uppercase">Accepting New Projects</span>
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl lg:text-8xl font-display font-black text-white leading-tight md:leading-none tracking-tight mb-6 max-w-5xl"
        >
          Sound That Sells. <br />
        ...
        >
          <Button
            ...
            size="lg"
            className="w-full sm:w-auto font-display font-medium uppercase tracking-wider text-sm rounded-none bg-primary text-white hover:bg-white hover:text-black hover:shadow-[0_0_30px_rgba(255,42,42,0.6)] transition-all duration-500 px-10 py-7"
          >
            View Work
          </Button>
          <Button
            ...
            variant="outline"
            size="lg"
            className="w-full sm:w-auto font-display font-medium uppercase tracking-wider text-sm rounded-none border-white/20 text-white hover:bg-white/10 hover:text-primary hover:border-primary/50 transition-all duration-500 px-10 py-7"
          >
            Get a Quote
          </Button>
        </motion.div>
